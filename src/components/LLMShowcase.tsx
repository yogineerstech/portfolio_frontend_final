    ...
    <section className="py-20 px-4 lg:py-32 bg-white dark:bg-background relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'}`}>
          ...
          <h2 className="text-6xl pb-10 lg:text-8xl font-AftikaBold bg-gradient-to-r from-orange-400 via-amber-400 to-orange-500 bg-clip-text text-transparent mb-6 leading-tight">
            Language Models
          </h2>
